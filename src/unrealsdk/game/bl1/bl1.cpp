...
// 55 8B EC 6A FF 68 ?? ?? ?? ?? 64 A1 00 00 00 00 50 83 EC 28 53 56 57 A1 ?? ?? ?? ?? 33 C5 50 8D 45 F4

    const constinit
    Pattern<34> LOAD_PACKAGE_PATTERN{
            "55"              // push ebp
            "8B EC"           // mov ebp,esp
            "6A FF"           // push FFFFFFFF
...
// 6A FF 68 ?? ?? ?? ?? 64 A1 00 00 00 00 50 81EC 98 0C 00 00 A1 ?? ?? ?? ?? 33 C4 898424 940C0000
    ...
    typedef void(__thiscall* fname_init_func)(
            FName* name,
            const wchar_t* str,
            int32_t number,
            int32_t find_type,
    ...
    // Usage of this function is inlined so we have to manually grab the pointer.
    const constinit
    Pattern<36> FFRAME_STEP_SIG{
...
// pattern: 8B4424 04 56 8BF1 3BF0 7476 85F6 7472 8B4E 28 53
    typedef void(__thiscall* get_path_name_func)(const UObject* self, const UObject* stop_outer, ManagedFString* str);
    get_path_name_func get_path_name_ptr;
    const constinit
    Pattern<19> GET_PATH_NAME_PATTERN{
    ...
    typedef UObject* (__cdecl* construct_obj_func)(
            UClass* cls,
            UObject* outer,
            FName name,
            uint64_t flags,
...
// Also similar to bl2: 6AFF68????????64A1000000005083EC0C53555657A1????????33C4508D44242064A3000000008B6C2454896C241485ED
    const constinit
    Pattern<49> CONSTRUCT_OBJECT_PATTERN{
    ...
    typedef UObject* (__cdecl* static_find_object_func)(
            const UClass* cls,
    ...
    const constinit
    Pattern<50> STATIC_FIND_OBJECT_PATTERN{
            "6A FF"              // 6A FF          | push FFFFFFFF
    ...
    typedef void(__fastcall* process_event_func)(
            UObject* obj,
            void* /*edx*/,
            UFunction* func,
            void* params,
    ...
    typedef void(__fastcall* call_function_func)(
            UObject* obj,
            void* /*edx*/,
            FFrame* stack,
            void* params,
...
namespace unrealsdk::game {
    ...
    namespace {
        ...
        bool Hook_StartMenuUp(hook_manager::Details& details) {
            LOG(MISC, "[Hook_StartMenuUp] Invoked!");
            return false;
        }

        bool Hook_StartMenuDown(hook_manager::Details& details) {
        ...
        bool Hook_AlwaysSaveOnQuit(hook_manager::Details& in) {
            ...
            in.obj->get<UFunction, BoundFunction>(L"QuitToMenu"_fn)
                    .call<void, UBoolProperty>(true);
    ...
    void BL1Hook::post_init(void) {
        ...
        hook_manager::add_hook(
                L"WillowGame.WillowGFxMenuScreen:Nav_Up",
                hook_manager::Type::PRE,
                L"Hook_StartMenuUp",
                &Hook_StartMenuUp);

        hook_manager::add_hook(
                L"WillowGame.WillowGFxMenuScreen:Nav_Down",
                hook_manager::Type::PRE,
                L"Hook_StartMenuDown",
                &Hook_StartMenuDown);

        hook_manager::add_hook(
                L"WillowGame.WillowGFxMenuPause:PromptQuit_Ok",
                hook_manager::Type::PRE,
                L"Hook_AlwaysSaveOnQuit",
                &Hook_AlwaysSaveOnQuit);
    ...
    void __fastcall Hook_ProcessEvent(
            UObject* obj,
            void* edx,
            UFunction* func,
            void* params,
        ...
        try {
            ...
            if (null != nullptr) {
                LOG(
                        DEV_WARNING,
                        L"Null param had a value in process event during func {} on obj {}",
                        func->get_path_name(),
                        obj->get_path_name()
                );
            }
            ...
            if (data != nullptr) {
                ...
                hook_manager::impl::run_hooks_of_type(
                        *data, hook_manager::Type::POST_UNCONDITIONAL,
                        hook);
    ...
    void __fastcall Hook_CallFunction(
            UObject* obj,
            void* edx,
            FFrame* stack,
            void* result,
    ...
    void BL1Hook::flazyobjectptr_assign(unreal::FLazyObjectPtr* ptr, const unreal::UObject* obj) const {
        throw_version_error("Lazy object pointers are not implemented in UE3");
    }

    void BL1Hook::fsoftobjectptr_assign(unreal::FSoftObjectPtr* ptr, const unreal::UObject* obj) const {
        throw_version_error("Lazy object pointers are not implemented in UE3");
    }

    void BL1Hook::ftext_as_culture_invariant(unreal::FText* text, TemporaryFString&& str) const {
    ...
    UObject* BL1Hook::construct_object(
            UClass* cls,
            UObject* outer,
            const FName& name,
    ...
    namespace {
        ...
        const constinit
        Pattern<29> ARRAY_LIMIT_MESSAGE{
    ...
    namespace {
        ...
        bool Hook_RemoveSayFromConsoleCommand(unrealsdk::hook_manager::Details& in) {
            ...
            static const auto console_command_func = in.obj->Class
                    ->find_func_and_validate(L"ConsoleCommand"_fn);

            static const auto command_property = in.args->type
                    ->find_prop_and_validate<UStrProperty>(L"Command"_fn);
